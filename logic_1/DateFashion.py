...
style of 2 or less, then the result is 0 (no). Otherwise the result is 1
(maybe).
date_fashion(5, 10) → 2
date_fashion(5, 2) → 0
date_fashion(5, 5) → 1
...
@author LZ-FSDev
@see https://codingbat.com/prob/p129125
@since 3.10.2
@version 0.0.1
'''
...
print("date_fashion(5, 10) -> " + str(date_fashion(5, 10)))
print("date_fashion(5, 2) -> " + str(date_fashion(5, 2)))
print("date_fashion(5, 5) -> " + str(date_fashion(5, 5)))
