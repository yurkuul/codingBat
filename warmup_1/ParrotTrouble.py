...
print("parrot_trouble(True, 6) -> " + str(parrot_trouble(True, 6)))
print("parrot_trouble(True, 7) -> " + str(parrot_trouble(True, 7)))
print("parrot_trouble(False, 6) -> " + str(parrot_trouble(False, 6)))
