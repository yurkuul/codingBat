...
author LZ-FSDev
see https://codingbat.com/prob/p179960
'''
...
print("round_sum(16, 17, 18) -> " + str(round_sum(16, 17, 18)))
print("round_sum(12, 13, 14) -> " + str(round_sum(12, 13, 14)))
print("round_sum(6, 4, 4) -> " + str(round_sum(6, 4, 4)))
